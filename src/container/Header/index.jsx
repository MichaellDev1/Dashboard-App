...
export default function Header ({ handleOpenMenuUser }) {
  ...
  return (
    <header className='text-black h-24 items-center w-full flex justify-between px-10 py-5 bg-[#f9f9f9]'>
      <form action='' className='relative'>
        <div className='absolute top-[11px] text-[#000000] left-3 text-lg'>
          <FiSearch />
        </div>
        <input type='text' name='' id='' className='text-base pl-10 py-2 rounded-2xl sm:min-w-[300px] w-[110px] placeholder:text-[#868686] outline-none font-normal bg-white' style={{ boxShadow: '1px 5px 45px rgba(0 0 0 / 4%)' }} placeholder='Search' />
      </form>
      <div className='flex justify-center items-center gap-5'>
        <div className='text-[26px] flex items-center justify-center gap-4 '>
